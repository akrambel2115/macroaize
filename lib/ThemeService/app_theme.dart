...
class AppTheme {
  static final dark = ThemeData.dark().copyWith(
    ...
    // dark overlay states
    hoverColor: AppColor.neutralGrey800.withValues(alpha: 0.12),
    highlightColor: AppColor.neutralGrey800.withValues(alpha: 0.12),
  ...
  static final light = ThemeData.light().copyWith(
    ...
    highlightColor: AppColor.neutralGrey100.withValues(alpha: 0.5),
    hoverColor: AppColor.neutralGrey100.withValues(alpha: 0.3),
    splashColor: AppColor.neutralGrey100.withValues(alpha: 0.4),
