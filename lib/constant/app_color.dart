...
class AppColor {
  ...
  // Shadow Colors
  static Color lightShadow = Colors.black.withValues(alpha: 0.06);
  static Color mediumShadow = Colors.black.withValues(alpha: 0.12);
  static Color heavyShadow = Colors.black.withValues(alpha: 0.25);
