...
import 'package:macroaize/screens/splash/splash_controller.dart';
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children:
                        controller.appNameLetters.map((letterData) {
                          int index = controller.appNameLetters.indexOf(
                            letterData,
                          );
                          return AnimatedBuilder(
                            ...
                            builder: (context, child) {
                              // fade in opacity
                              double opacity =
                                  controller.letterAnimations[index].status ==
                              ...
                              return Transform.translate(
                                offset: Offset(
                                  0,
                                  controller.letterAnimations[index].value,
                                ),
                                child: Opacity(
                                  opacity: opacity,
