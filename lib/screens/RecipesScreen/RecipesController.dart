...
class RecipesController extends GetxController {
  ...
  void openRecipeDetails(Recipe recipe) {
    // Performance: Use Get.defaultDialog for better performance than custom AlertDialog
    Get.defaultDialog(
      title: recipe.title,
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            _buildInfoRow(Icons.schedule_rounded, 'Duration', '${recipe.duration} minutes'),
            _buildInfoRow(Icons.local_fire_department_rounded, 'Calories', '${recipe.calories} cal'),
            _buildInfoRow(Icons.star_rounded, 'Difficulty', recipe.difficulty),
