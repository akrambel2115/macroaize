...
class _OrbPainter extends CustomPainter {
  ...
  final basePaint = Paint()..color = color.withValues(alpha: 0.3);
  ...
  if (progress >= 1.0 && sparkle > 0) {
    ...
    final ring = Paint()
      ...
      ..strokeWidth = 2
      ..color = AppColor.primaryOrange.withValues(alpha: 0.6 * sOpacity)
    ...
    for (int i = 0; i < sparkCount; i++) {
      ...
      canvas.drawCircle(pos, 2.0 + 1.0 * (1 - sparkle), Paint()..color = AppColor.primaryOrange.withValues(alpha: 0.9 * sOpacity));
    }
  }
