...
class _ModernButtonState extends State<ModernButton> 
    ...
    switch (widget.style) {
      case ModernButtonStyle.primary:
        return BoxDecoration(
          gradient: isEnabled 
            ...
            : LinearGradient(
                colors: [
                  AppColor.primaryOrange.withValues(alpha: opacity),
                  AppColor.primaryGreenLight.withValues(alpha: opacity),
                ],
              ),
      ...
      case ModernButtonStyle.outline:
        return BoxDecoration(
          ...
          borderRadius: widget.borderRadius ?? BorderRadius.circular(12),
          border: Border.all(
            color: AppColor.primaryOrange.withValues(alpha: opacity),
            width: 2,
          ),
        );
      ...
      case ModernButtonStyle.gradient:
        return BoxDecoration(
          gradient: isEnabled 
            ...
            : LinearGradient(
                colors: [
                  AppColor.accentOrange.withValues(alpha: opacity),
                  AppColor.accentOrangeLight.withValues(alpha: opacity),
                ],
              ),
          borderRadius: widget.borderRadius ?? BorderRadius.circular(12),
          boxShadow: isEnabled && !_isPressed ? [
  ...
  Color _getTextColor(BuildContext context) {
    ...
    switch (widget.style) {
      case ModernButtonStyle.primary:
      case ModernButtonStyle.gradient:
        return AppColor.neutralWhite.withValues(alpha: opacity);
        
      case ModernButtonStyle.secondary:
        return context.theme.primaryColor.withValues(alpha: opacity);
        
      case ModernButtonStyle.outline:
      case ModernButtonStyle.ghost:
        return AppColor.primaryOrange.withValues(alpha: opacity);
    }
  }
